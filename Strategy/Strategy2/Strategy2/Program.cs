...
namespace RefactoringGuru.DesignPatterns.Strategy.Conceptual
{
    ...
    class Context
    {
        ...
        public void DoSomeBusinessLogic()
        {
            ...
            var result = this._strategy.DoAlgorithm(new List<string> { "e" ,"a" ,"d" ,"b" ,"c" });

            string resultStr = string.Empty;
            foreach (var element in result as List<string>)resultStr += element + ",";
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nClient: Strategy is set to as is.");
